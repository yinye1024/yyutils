...
%%%-------------------------------------------------------------------
-module(yyu_proc_time_cache_item).
-author("yinye").
...
-export([is_expired/1,get_expired_time/1,set_expired_time/2]).
...
is_expired(ItemMap)->
  yyu_proc_time_cache_item:get_expired_time(ItemMap) > yyu_time:now_seconds().
